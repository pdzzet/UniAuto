...
{
	#region SBRMAPCDATADOWNLOAD

	/// <summary>
	/// SBRMAPCDATADOWNLOAD object for NHibernate mapped table 'SBRM_APCDATADOWNLOAD'.
	/// </summary>
	public class APCDataDownloadEntityData:EntityData
	{
