...
namespace UniAuto.UniBCS.Entity
{
	...
	public class RECIPE : EntityData
	{
		...
		protected DateTime _lASTUPDATEDT = DateTime.Now;
		...
		public RECIPE( string fABTYPE, string lINETYPE, string oNLINECONTROLSTATE, string lINERECIPENAME, string pPID, DateTime lASTUPDATEDT, string uPDATEOPERATOR, string uPDATELINEID, string uPDATEPCIP, string rEMARK, string rECIPETYPE )
		{
