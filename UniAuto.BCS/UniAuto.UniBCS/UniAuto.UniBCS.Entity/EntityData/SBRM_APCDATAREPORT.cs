...
{
	#region SBRMAPCDATAREPORT

	/// <summary>
	/// SBRMAPCDATAREPORT object for NHibernate mapped table 'SBRM_APCDATAREPORT'.
	/// </summary>
	public class APCDataReportEntityData:EntityData
	{
