...
{
	[XmlRoot("MESSAGE")]
	public class RecipeRegisterValidationReturnReport : Message
	{
		public class LINEc
		{
		...
		public RecipeRegisterValidationReturnReport()
		{
			this.Direction = Spec.DirType.BC_TO_OPI;
            this.WaitReply = ""; // "RecipeRegisterValidationReturnReply";
