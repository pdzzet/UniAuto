...
{
	[XmlRoot("MESSAGE")]
	public class AllEquipmentStatusReply : Message
	{
		public class EQUIPMENTc
		{
            ...
            public string OXINFOCHECKFLAG { get; set; }  //add by qiumin 20180607
			...
			public EQUIPMENTc()
			{
                ...
                OXINFOCHECKFLAG = string.Empty; //add by qiumin 20180607
		...
		public AllEquipmentStatusReply()
		{
