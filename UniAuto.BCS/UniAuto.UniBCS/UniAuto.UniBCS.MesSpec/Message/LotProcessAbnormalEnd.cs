...
{
	[XmlRoot("MESSAGE")]
	public class LotProcessAbnormalEnd : Message
	{
		public class PRODUCTc
		{
            ...
            public bool MESPROCESSFLAGbool { get; set; }
            public string MESPROCESSFLAG     //add by yang 20161112 
            {
			...
			public string ACTCFREWORKCOUNT { get; set; }
		...
		public class TrxBody : Body
		{
			...
			[XmlIgnore]
			public bool PARTIALFULLFLAGbool { get; set; }

			public string PARTIALFULLFLAG
			{
				get{ return PARTIALFULLFLAGbool ? "Y" : "N"; }
				set{ PARTIALFULLFLAGbool = (string.Compare(value, "Y", true) == 0); }
			}
			...
			public string CSTMAPGRADE { get; set; }
			...
			public string NOPROCESSFLAG { get; set; }
		...
		public LotProcessAbnormalEnd()
		{
			this.Direction = Spec.DirType.BC_TO_MES;
			this.WaitReply = "LotProcessAbnormalEndReply";
