...
namespace UniOPI
{
    public partial class FormRecipeManagement_NodeParameterCheck : FormBase
    {
        public FormRecipeManagement_NodeParameterCheck()
        {
            InitializeComponent();
        }

        private void FormRecipeManagement_NodeParameterCheck_Load(object sender, EventArgs e)
        {
            try
            {
                int _ctlTabIdx = 1;
                ...
                foreach (Node _node in FormMainMDI.G_OPIAp.Dic_Node.Values)
                {
                    ...
                    _chk.Checked = _node.RecipeParameterCheck;
            ...
            try
            {
                ...
                switch (_btn.Name)
                {
                    case "btnOK":
                        ...
                        string _msg = string.Format("Please confirm whether you will update Recipe Parameter Enable setting ?");
                        ...
                        foreach (Control _ctrl in flpNode.Controls)
                        {
                            ...
                            if (FormMainMDI.G_OPIAp.Dic_Node[_chk.Name].RecipeParameterCheck != _chk.Checked)
                            {
                                ...
                                _change.RECIPEPARAVALIDATIONENABLED = _check;

                                _sqlDesc = _sqlDesc + (_sqlDesc == string.Empty ? string.Empty : ";") + string.Format("MOD [ {0} RecipeParameterCheck Set {1} ] ", _ctrl.Name, _check);
                            }
                        }
                        ...
                        string _err = UniTools.InsertOPIHistory_DB("SBRM_NODE:RECIPEPARAVALIDATIONENABLED", _sqlDesc, _sqlErr);
                        ...
                        Public.SendDatabaseReloadRequest("SBRM_NODE:RECIPEPARAVALIDATIONENABLED");
                        ...
                        ShowMessage(this, this.lblCaption.Text, "", "Update Recipe Parameter Setting Success!", MessageBoxIcon.Information);
