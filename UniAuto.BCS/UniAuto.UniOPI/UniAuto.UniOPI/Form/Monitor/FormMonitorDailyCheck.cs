...
namespace UniOPI
{
    public partial class FormMonitorDailyCheck : FormBase
    {
        #region Fields
        private Button CurrNodeBtn = null;
        #endregion

        public FormMonitorDailyCheck()
        {
            InitializeComponent();
            lblCaption.Text = "Daily Check";
        }

        private void FormMonitorDailyCheck_Shown(object sender, EventArgs e)
        {
            this.Initial();
        }
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DailyCheckReportRequest request = new DailyCheckReportRequest();
                ...
                #region DailyCheckReportReply

                string _respXml = _resp.Xml;

                DailyCheckReportReply _dailyCheckReportReply = (DailyCheckReportReply)Spec.CheckXMLFormat(_respXml);

                #region Update Data
                SetGridViewData(_dailyCheckReportReply);
                #endregion
        ...
        private void SetGridViewData(DailyCheckReportReply reply)
        {
            try
            {
                DataTable dt = null;
                if (dgvData.DataSource == null)
                {
                    ...
                    foreach (DailyCheckReportReply.DATAc data in reply.BODY.DATALIST)
                    {
                ...
                else
                {
                    ...
                    if (reply.BODY.DATALIST.Count < dt.Rows.Count)
                    {
                        ...
                        DailyCheckReportReply.DATAc currDATAc = null;
