...
namespace UniOPI
{
    public partial class FormRecipeParameterManagementEdit : FormParamManagementBaseEdit
    {
        private SBRM_RECIPEPARAMETER ObjEdit;

        public FormRecipeParameterManagementEdit()
            : base(ParamForm.RecipeParameter)
        {
            InitializeComponent();
        }

        public FormRecipeParameterManagementEdit(SBRM_RECIPEPARAMETER objData)
            : this()
        {
            if (objData == null)
            {
        ...
        private void FormRecipeParameterManagementEdit_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                ...
                switch (FormMode)
                {
                    case FormMode.AddNew:
                        ...
                        SBRM_RECIPEPARAMETER _objData = null;

                        foreach (DataGridViewRow _row in dgvAddList.Rows)
                        {
                            _objData = new SBRM_RECIPEPARAMETER();
                            ...
                            _ctxBRM.SBRM_RECIPEPARAMETER.InsertOnSubmit(_objData);
                        }
