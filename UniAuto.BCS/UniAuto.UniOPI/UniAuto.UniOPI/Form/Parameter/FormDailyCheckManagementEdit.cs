...
namespace UniOPI
{
    public partial class FormDailyCheckManagementEdit : FormParamManagementBaseEdit
    {
        private SBRM_DAILYCHECKDATA ObjEdit;

        public FormDailyCheckManagementEdit()
            : base(ParamForm.DailyCheckManagement)
        {
            InitializeComponent();
        }

        public FormDailyCheckManagementEdit(SBRM_DAILYCHECKDATA objData)
            : this()
        {
            if (objData == null)
            {
        ...
        private void FormDailyCheckManagementEdit_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                ...
                switch (FormMode)
                {
                    case FormMode.AddNew:
                        ...
                        SBRM_DAILYCHECKDATA _objData = null;

                        foreach (DataGridViewRow _row in dgvAddList.Rows)
                        {
                            _objData = new SBRM_DAILYCHECKDATA();
                            ...
                            _ctxBRM.SBRM_DAILYCHECKDATA.InsertOnSubmit(_objData);
                        }
